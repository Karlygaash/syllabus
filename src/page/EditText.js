...
const EditText = () => {
    ...
    const getSyllabusById = () => {
		...
		axios
			...
			.then(result => {
                setText2(result.data.text.text2)
                setText3(result.data.text.text3)
                setText4(result.data.text.text4)
                setText5(result.data.text.text5)
                setText6(result.data.text.text6)
                setText7(result.data.text.text7)
                setText8(result.data.text.text8)
			})
			.catch(error => {
                console.log(error)
			})
